...
<div class="relative mt-6 mr-2 overflow-x-auto shadow-md sm:rounded-lg">
    ...
    @if (session()->has('deleteError')) <div class= red-alert" role="alert">
                    <svg class="flex-shrink-0 inline w-4 h-4 mr-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z" />
                    </svg>
                    <span class="sr-only">Info</span>
...
<h1 class="mb-4 text-2xl font-extrabold tracking-tight leading-none text-gray-900 md:text-2xl lg:text-2xl dark:text-white">Daftar Lowongan Kerja</h1>
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="font-bold px-4 py-1 text-center font-w
    @if ($loker->status === 'Aktif') text-green-500
    @elseif($loker->status === 'Sedang Seleksi') text-yellow-500 
    @elseif($loker->status === 'Tutup') text-red-500 @endif
">
                    {{ $loker->status }}
                </td>
